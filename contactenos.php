...
<title>Contáctenos | BIGMARKET.COM MAYORISTA</title>
...
<section id="baccolor">
	<div class="titulo2">
	 ...
	 <div class="conte-emp">
	 	<h2>Contáctanos</h2>
	 	<p>Envíanos un mensaje y te contestaremos tan pronto como sea posible.</p>
	 	<div id="conc1">
	 	<form>
	 	...
	 	<div id="conc2">
	 	<textarea placeholder="Escribenos tu mensaje" required></textarea>
	 	</div>
			...
			<div id="cd-login">
				<form class="cd-form" id="iniciar">
					...
					<p class="fieldset">
						...
						<input class="full-width has-padding has-border" type="text" placeholder="Password" name="password">
