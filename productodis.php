<?php
	...
	else
	{
		...
		if($prod=='')
			$prod = '%';
		$bus2 = mysql_query("SELECT * FROM distribuidores WHERE Nit_ds='$us' ");
...
<div class="submenu">
	...
	<form class="forma" id="producto">
		...
		<input type="text" placeholder="Nombre del Producto" class="auto"  name="nombre" required >
		<input type="text" placeholder="Caracteristica" name="descr" required disabled>
		<input type="number" placeholder="Valor Unitario" name="valor" required >
...
<div id="verproductos" style="display:none">
	<form class="forma" method="GET" action="productodis">
		<p>Busqueda:</p>
		<input type="text" placeholder="Nombre del Producto" class="auto2" name="prod" required>
...
<script type="text/javascript" src="js/script_productodis.js"></script>
<script type="text/javascript" src="js/jquery-ui.min.js"></script>
<?php
	if(isset($_GET['pn']) || isset($_GET['prod'])){
		echo "<script>$('#verproductos').fadeIn();</script>";
	}
?>
